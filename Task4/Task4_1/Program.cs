namespace Task4_1
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            matrixTracker.Undo();
            matrixTracker.Undo();
            DiagonalMatrix<int> diagonalMatrix2 = new DiagonalMatrix<int>(4);
            diagonalMatrix2[0, 0] = 5;
            diagonalMatrix2[1, 1] = 6;
            diagonalMatrix2[2, 2] = 7;
            diagonalMatrix2[3, 3] = 8;
            diagonalMatrix2[4, 4] = 9;
            SumDelegate<int> sumDelegate = new SumDelegate<int>(Sum);
            DiagonalMatrix<int> resultDiagonalMatrix = diagonalMatrix.SumDiagonalMatrixs(diagonalMatrix2, sumDelegate);
        }
